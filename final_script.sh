...
#Your hmmbuild and hmmsearch will need to be in the current directory (IB20_Bioinformatics) for this to work
./hmmbuild hsp70hmmbuild hsp70muscleresult
./hmmbuild mcrAhmmbuild mcrAmuscleresult
